...
async function runDirectWebSearchWithAI(
  ...
  const prompt=systemPrompt+
    ...
    `Do NOT write a Sources/References section, [Source 1] labels, raw URLs, or markdown source links in your answer. `+
    `The application will display the retrieved sources separately at the very end of the message. `+
    `Answer naturally and directly, as a clean ChatGPT-style response.\n\n`+
    `RETRIEVED SOURCES:\n${context}\n\nUSER REQUEST:\n${message}`;
